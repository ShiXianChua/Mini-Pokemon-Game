...
public class TeamA {
    ...
    public void pickPokemon() {
        ...
        System.out.println("\nChoose your pokemon:");
        String pokemonChosen = s.nextLine();
        this.name = pokemonChosen;
    }

    public void display(String pokemonName) throws IOException {
        System.out.println("You have chosen: " + pokemonName);
        try {
            ...
            Scanner s = new Scanner(new FileInputStream(pokemonName + ".txt"));
